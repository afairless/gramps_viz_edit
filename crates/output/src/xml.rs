...
pub struct GraphXmlWriter {
    ...
    /// Schema version for the XML header (e.g. "5.2").
    schema_version: String,
}

impl GraphXmlWriter {
    /// Create a new `GraphXmlWriter` with the given [`SerializationMap`] and schema version.
    ...
    fn write_header(&self, writer: &mut impl std::io::Write) -> Result<(), SerializationError> {
        ...
        writeln!(
            ...
            self.creation_date, self.schema_version
        )?;
